...
| C15-RCC-RES-A-RERUN-002 | **READY** | 新 RC 专用 fresh Resident A；必须 checkout frozen software `773876f92d5f8e53422f8f5a68cc651953d93052`，fresh private World + fresh session，Phase A cursor 1..13；不得读取/复制 #117 或任何旧 Resident 语义结果；prompt `governance/prompts/C15_RCC_RES_A_RERUN_002_2026-09-24.md` |
| C15-RCC-RES-A-RERUN-002-ACCEPT-001 | **BLOCKED** | 等 `C15-RCC-RES-A-RERUN-002` 完成后由 fresh independent reviewer 验收 exact evidence head；不修 run、不运行 B |
...
FIX-001 / FIX-002 / FIX-003 三项 audited Core gap 已全部独立接受并集成；CG-001/002/003 均 CLOSED。`CORE-HEADLESS-001`、`CORE-RECOVERY-001`、`CORE-SCALE-001`、`CORE-RC-FREEZE-001` 均已独立接受并集成；RC impact 独立复核仍为 `FRESH_A_REQUIRED`。当前唯一合法下一任务为 `C15-RCC-RES-A-RERUN-002 = READY`；其独立验收通过前不得进入 B preflight / B / C。CI corrective 已关闭。
