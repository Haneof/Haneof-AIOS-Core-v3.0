...
| 29.4 | `C15-RCC-RES-A-RERUN-001` | 在 fixed Core 上使用 frozen C15 fixture，从 fresh private World / fresh session 重新执行 Phase A cursor 1..13；必须由新的真实 Resident A 窗口逐事件生活 | **RUN COMPLETE / AWAITING INDEPENDENT ACCEPTANCE** | C15-RCC-RES-A-REPAIR-DECISION-001 | post-fix fresh rerun evidence frozen on `resident/c15-rcc-res-a-rerun-20260922-sol`; new OPEN / UNMERGED evidence PR to be used for PM acceptance; PR #101 remains superseded diagnostic only | 13/13 sequential durable acks complete; final simulated time 2026-11-06T11:10:00-08:00; World/Index 77/77 lag 0; Resident run must be independently accepted before B can become READY |
