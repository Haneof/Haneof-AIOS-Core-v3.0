...
| 6 | `T35-RULE-001` | 只做“非 Action Task 的可信完成凭据”语义裁决；不改 execution 代码 | **READY** | AUDIT-001 | AUDIT-001=`STILL_OPEN`; Issue #30 / #35 | 形成唯一裁决文档；明确什么可构成完成证据，禁止伪造外部 Outcome、禁止仅凭 AI 自述 |
