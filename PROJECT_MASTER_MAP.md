...
- S2 当前：`CORE-GAP-FIX-002 = DONE`；`CORE-GAP-FIX-001 = DONE`（#171 corrective ACCEPTANCE_PASS；#145 exact `a56f113a...` merged as `d97a1bfa...`）；`CORE-GAP-FIX-003` 历史 #162 ACCEPTANCE_FAIL 保留，其 corrective head `ac8d5a43...` 因 FIX-001 已先集成，现 `REBASE_REVALIDATION_REQUIRED`：继续原 #157 基于新 main 重跑并重新独立验收。`CORE-CI-FIX-001 = DONE`。
