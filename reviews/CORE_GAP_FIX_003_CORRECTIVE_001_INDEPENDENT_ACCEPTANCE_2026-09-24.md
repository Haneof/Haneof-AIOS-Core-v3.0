...
Final main commit message:

`Merge CORE-GAP-FIX-001 temporal read-cut corrective (#145)`
...
- new live main = `d97a1bfa527caadb4ab22d232fd627c0483e02d8`

Current #157 head remains:

`ac8d5a43993a50caa27fe89a52f55a6e6e69ec9d`

Comparing new live main to the current #157 head shows they are now diverged from merge base `f8eb271453b12c3896cd55381b8bdb8dc5da5632`.

The new main contains real FIX-001 Core changes including:
...
This is not an implementation failure finding against the reviewed `ac8d5a43...` semantics. It is the mandatory serialized-integration gate.
...
1. merge/rebase current live main `d97a1bfa527caadb4ab22d232fd627c0483e02d8` into the existing PR #157 branch;
