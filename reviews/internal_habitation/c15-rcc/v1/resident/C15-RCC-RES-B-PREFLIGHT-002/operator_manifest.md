...
- **C014-FIXUP-006 lifecycle checker blob**: `72f674b2d430262a5eff9cb66c7004917c0f4ae4`. Frozen active runbook blobs: startup `c56f528f4ea181ae002ed22d3e810ab6022ddb17`; per-cursor `17f27956152f4edd49b57f72c7546eef668406fa`. The E2E probe and final-freeze procedure remain unchanged from C013.
...
- **Fresh-run rule**: CORRECTIVE-013 evidence is historical. C014-FIXUP-006 is qualified only by a fresh frozen Debian 12 / Python 3.11.2 run committed byte-exact into `isolation/e2e_probe_output.txt`, with cross-document `5`, executable `18`, shell-semantics `82`, `ALL_CHECKS=158/158 FAILURES=0`, and the zero cursor-14 payload-leak invariant.
