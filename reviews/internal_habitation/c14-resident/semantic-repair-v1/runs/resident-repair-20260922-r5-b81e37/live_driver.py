...
RUN_ID = "c14-sem-repair-resident-20260922-sol-r5-b81e37"
SESSION_ID = "resident-sem-repair-sol-20260922-r5-b81e37"
SUBJECT_ID = "user_1"
...
COMMENT_LIMIT = 56000
POLL_SECONDS = 4.0
CONTROL_NONCE = "ctl-b81e37-4a96d2"
...
class GithubBridge:
    ...
    def _write_branch_json(self, relpath: str, payload: Any, message: str) -> None:
        existing = self._contents_get(relpath)
        body = {
            "message": message,
        ...
        encoded_path = urllib.parse.quote(relpath, safe="/")
        self._api("PUT", f"/contents/{encoded_path}", body)
    ...
    def post_chunks(self, kind: str, item_id: str, payload: Any) -> None:
        ...
        out_path = f"{rel}/bridge_out/{kind.lower()}_{item_id}.json"
        self._write_branch_json(
            out_path,
            {
                "run_id": RUN_ID,
                "kind": kind,
            ...
            f"bridge(c14): publish {kind.lower()} {item_id}",
        )
...
def main() -> int:
    ...
    run_manifest = {
        ...
        "provider_request_attestation": None,
        "control_transport": "GitHub Contents API bridge with private nonce; no PR/comment control",
