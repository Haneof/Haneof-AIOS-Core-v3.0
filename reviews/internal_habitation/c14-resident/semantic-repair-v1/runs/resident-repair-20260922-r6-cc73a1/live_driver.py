...
RUN_ID = "c14-sem-repair-resident-20260922-sol-r6-cc73a1"
SESSION_ID = "resident-sem-repair-sol-20260922-r6-cc73a1"
SUBJECT_ID = "user_1"
...
COMMENT_LIMIT = 56000
POLL_SECONDS = 4.0
CONTROL_NONCE = "ctl-cc73a1-58f40e"
...
def main() -> int:
    ...
    run_manifest = {
        ...
        "provider_request_attestation": None,
        "control_transport": "PR comments are output-only; Resident decisions come only from nonce-scoped branch control JSON",
