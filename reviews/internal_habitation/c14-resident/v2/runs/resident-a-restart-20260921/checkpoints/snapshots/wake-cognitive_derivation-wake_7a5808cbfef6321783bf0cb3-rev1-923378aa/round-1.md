# RuntimeSnapshot — wake-cognitive_derivation-wake_7a5808cbfef6321783bf0cb3-rev1
...
```text
Cognitive derivation wake. The exact pinned Summary is only a temporal/navigation anchor: it is not a Claim, a semantic conclusion, or sufficient evidence by itself. Inspect its real leaf evidence, existing cognition, counter-evidence, and any cross-dimensional world state you judge relevant. Normal search, inspect, timeline, compare, recall, ALL_DIMENSIONS and Outcome inspection remain available. Only form, revise, or retract durable cognition when pinned support closes to qualifying non-Summary reality/case evidence. If evidence is insufficient or understanding should not change, silence is a correct successful result. The Wake contains no expected Claim.
```
...
```json
{
  ...
  "task_context": {
    "cognitive_derivation": {
      ...
      "summary_revision": 3,
      "summary_window": {
        "end": "2026-10-09T23:59:59.999999Z",
        "precision": "day",
    ...
    "wake": {
      ...
      "dedupe_key": "c14:cognitive-derivation:sum_9e81acf33a4abc28c291e3af:3",
      ...
      "first_hit_at": "2026-10-11T12:48:00+00:00",
      "hit_count": 1,
      "last_hit_at": "2026-10-11T12:48:00+00:00",
      "priority": 50,
  ...
  "token_budget": 3400,
  "truncated": true,
  "user_input": "Cognitive derivation wake. The exact pinned Summary is only a temporal/navigation anchor: it is not a Claim, a semantic conclusion, or sufficient evidence by itself. Inspect its real leaf evidence, existing cognition, counter-evidence, and any cross-dimensional world state you judge relevant. Normal search, inspect, timeline, compare, recall, ALL_DIMENSIONS and Outcome inspection remain available. Only form, revise, or retract durable cognition when pinned support closes to qualifying non-Summary reality/case evidence. If evidence is insufficient or understanding should not change, silence is a correct successful result. The Wake contains no expected Claim.",
  "world_map": {
    "as_of": "2026-10-11T12:49:01+00:00",
    "dimension_count": 6,
    "dimensions": [
      {
        "current_object_count": 69,
        "definition_ref": null,
        "dimension": "dim_unclassified",
        "latest_activity_at": "2026-10-11T12:49:01+00:00",
        "lifecycle": null,
        "name": null,
        "object_types": [
          "dependency",
...
[
  ...
  },
  {
    ...
    "data": {
      "claim_refs": [],
      "content": "2026-10-09 工作产出（AI 认知记录，非现实观测）：本窗口仅含本 Resident 于 10-09T01:11Z 写入的一条 hypothesis 级 Claim「写作块交付与日程保护程度相关（截至 10-08 的 3 次观察）」及其证据集（9 条观测）；窗口内无新的现实工作产出观测。",
      "coverage": {
        "dimension": "dim:work_outcome",
        "source_count": 2,
        "truncated": false
      ...
      "dimension_ref": null,
      "evidence_set_ref": null,
      "granularity": "day",
      "learned_at": "2026-10-11T12:48:00Z",
      "metadata": {
        "dimension": "dim:work_outcome",
